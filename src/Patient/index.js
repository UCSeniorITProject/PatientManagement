...
module.exports = (fastify, options, next) => {
	fastify.delete('/patient', {schema: patientSchema.deletePatient}, patientService.deletePatient);
	fastify.patch('/patient/:id', {schema: patientSchema.patchPatient}, patientService.patchPatient);
